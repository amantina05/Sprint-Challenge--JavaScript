...
const universities = [];
  for (let i = 0; i < graduates.length; i++){
    let curr = graduates[i]
      universities.push(curr.university)
  }
...
const contactInfo = [];
  for (let i = 0; i < graduates.length; i++){
    let curr = graduates[i]
      contactInfo.push(curr.first_name + ' ' + curr.email)
  }
...
const unisWithUni = [];
  for (let i = 0; i < graduates.length; i++){
    ...
    if (curr.university.includes('Uni')){
      unisWithUni.push(curr.university)
    }
  }
...
//     let curr = zooAnimals[i]
//     // displayNames.push('Name: ' + curr.animal_name + ', Scientific: ' + curr.scientific_name + '.' )
//     displayNames.push(`Name: ${curr.animal_name}, Scientific: ${curr.scientific_name}.`)
//   }
...
*/
const populationTotal = zooAnimals.reduce((accum, curr) => accum + curr.population, 0);
